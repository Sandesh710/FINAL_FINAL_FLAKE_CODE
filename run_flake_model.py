...
def parse_flake_nml(nml_path):
    ...
    # Now that we have depth_w and h_ML, compute T_mnw and T_bot properly
    # (moved from earlier to have access to depth_w)
    # This initialization matches FORTRAN behavior
